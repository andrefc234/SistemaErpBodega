...
CREATE TABLE "new_ClienteProducto" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "clienteId" TEXT NOT NULL,
    "nombre" TEXT NOT NULL,
    "precio" REAL NOT NULL,
    "codigoBarras" TEXT NOT NULL,
    CONSTRAINT "ClienteProducto_clienteId_fkey" FOREIGN KEY ("clienteId") REFERENCES "Cliente" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_ClienteProducto" ("clienteId", "codigoBarras", "id", "nombre", "precio") SELECT "clienteId", "codigoBarras", "id", "nombre", "precio" FROM "ClienteProducto";
DROP TABLE "ClienteProducto";
ALTER TABLE "new_ClienteProducto" RENAME TO "ClienteProducto";
CREATE TABLE "new_DiaEntrega" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "tiendaId" TEXT NOT NULL,
    "dia" INTEGER NOT NULL,
    CONSTRAINT "DiaEntrega_tiendaId_fkey" FOREIGN KEY ("tiendaId") REFERENCES "Tienda" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_DiaEntrega" ("dia", "id", "tiendaId") SELECT "dia", "id", "tiendaId" FROM "DiaEntrega";
DROP TABLE "DiaEntrega";
ALTER TABLE "new_DiaEntrega" RENAME TO "DiaEntrega";
CREATE TABLE "new_DiaPromotoria" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "tiendaId" TEXT NOT NULL,
    "dia" INTEGER NOT NULL,
    CONSTRAINT "DiaPromotoria_tiendaId_fkey" FOREIGN KEY ("tiendaId") REFERENCES "Tienda" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_DiaPromotoria" ("dia", "id", "tiendaId") SELECT "dia", "id", "tiendaId" FROM "DiaPromotoria";
DROP TABLE "DiaPromotoria";
ALTER TABLE "new_DiaPromotoria" RENAME TO "DiaPromotoria";
